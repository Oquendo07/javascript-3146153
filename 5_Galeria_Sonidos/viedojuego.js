const morir = document.querySelector('#muerte-song');
const winner = document.querySelector('#winner-song');
const gameOver = document.querySelector('#game-over');
const coins = document.querySelector('#coins-song');
...
const musicaFondo = new Audio('./Sonido de fondo.mp3');
...
document.addEventListener('click', () => {
  if (musicaFondo.paused) {
    musicaFondo.play().catch(err => console.warn("Autoplay bloqueado:", err));
  }
}, { once: true });
